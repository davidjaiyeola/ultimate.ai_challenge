...
public class SingleReplyServiceTest {
    ...
    private static IntentApiDto intentApiDto1;
    private static IntentApiDto intentApiDto2;
    ...
    public static void init() {
        ...
        intentApiDto1 = new IntentApiDto(1.0,"Greeting");
        intentApiDto2 = new IntentApiDto(0.1,"Ask");
        responseDto1 = new IntentApiResponseDto();
        responseDto2 = new IntentApiResponseDto();
        responseDto1.getIntents().add(intentApiDto1);
        responseDto1.getIntents().add(intentApiDto2);

        responseDto2.getIntents().add(new IntentApiDto(0.1,"Ask"));
    ...
    public void test_singleReply_no_intent_found_in_db(){
        Mockito.when(ultimateAIRestService.processHttpPost(dto2,"/intents")).thenReturn(responseDto2);
    ...
    public void test_singleReply_intent_found_in_db(){
        ...
        Mockito.when(ultimateAIRestService.processHttpPost(dto1,"/intents")).thenReturn(responseDto1);
        Mockito.when(singleReplyRepository.findById("Greeting")).thenReturn(Mono.just(singleReply));
    ...
    public void test_singleReply_highest_precedence(){
        ...
        assertThat(singleReplyService.singleReply(dto1).block(), is(responseDto1.getIntents().get(0).getName()));
